<?php
    ...
    /**
     * 🔹 Pending Failure Clock Requests
     */
    $sqlPending = "
        SELECT 
            fc.application_no,
    ...
    /**
     * 🔹 Approved Failure Clock Requests
     */
    $sqlApproved = "
        SELECT 
            fc.application_no,
    ...
    /**
     * 🔹 Rejected Failure Clock Requests
     */
    $sqlRejected = "
        SELECT 
            fc.application_no,
...
<html>
    <head>
        ...
        <title>Approver - Failure Clock</title>
...
<div id="layoutSidenav_content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3>Failure Clock (PENDING | APPROVED | REJECTED)</h3>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex gap-1">
                                <form method="POST" action="update_failure_clock_status.php">
